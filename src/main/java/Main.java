...
import com.calculator_module.exam.CalcultaAbleObject;
import com.calculator_module.exam.EnterToCalculate;
...
//        EnterToCalculate enterToCalculate = new EnterToCalculate("((1+2)*3*4/2)-13-(3+3)");
//        //EnterToCalculate enterToCalculate = new EnterToCalculate("2+2+3");
//        enterToCalculate.display();
//
//        CalcultaAbleObject c = new CalcultaAbleObject('(');
//        System.out.println(c.isBracket());
//        System.out.println(c.isOperation());
//        System.out.println(c.isHightPriority());
